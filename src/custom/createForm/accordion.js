...
import { UPDATE_ITEM_FOR_LIST_ACTION_ID, DELETE_ITEM_FOR_LIST_ACTION_ID } from '../../config';
    ...
    <ItemWrapper>
      <CustomAccordion>
        ...
        <CustomAccordionDetails>
          ...
          <Button startIcon={<DeleteIcon color="secondary" />} onClick={() => setOpenDelete(true)}>
            Delete
          </Button>
        </CustomAccordionDetails>
        <ItemEditForm
